...
# Form implementation generated from reading ui file 'uis/GUImain.ui'
#
...
"font-size: 10pt;")
        ...
        self.croplengthlabel.setGeometry(QtCore.QRect(10, 80, 101, 20))
...
"color: rgb(0,255,0);")
        ...
        self.vellcdnum.setLayoutDirection(QtCore.Qt.LeftToRight)
...
"color: rgb(0,255,0);")
        ...
        self.accellcdnum.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
...
"font-size: 10pt;")
        ...
        self.joystickbutton.setGeometry(QtCore.QRect(30, 80, 211, 31))
...
"            }")
        ...
        self.controlbutton.setGeometry(QtCore.QRect(30, 40, 211, 31))
...
"            }")
        ...
        self.import_excel_actions.setGeometry(QtCore.QRect(270, 40, 121, 31))
...
"            }")
        ...
        self.apply_actions.setGeometry(QtCore.QRect(280, 80, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setItalic(False)
...
"            }")
        ...
        self.ArduinoPortLabel = QtWidgets.QLabel(self.frame)
        self.ArduinoPortLabel.setGeometry(QtCore.QRect(10, 10, 150, 16))
        self.ArduinoPortLabel.setMaximumSize(QtCore.QSize(150, 25))
        self.ArduinoPortLabel.setObjectName("ArduinoPortLabel")
...
"            }")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 120, 401, 241))
        self.tabWidget.setObjectName("tabWidget")
        self.Control = QtWidgets.QWidget()
        self.Control.setObjectName("Control")
        self.gradient_status_checkbox = QtWidgets.QCheckBox(self.Control)
        self.gradient_status_checkbox.setGeometry(QtCore.QRect(10, 0, 141, 21))
        ...
        self.manualalphalabel.setGeometry(QtCore.QRect(10, 85, 41, 21))
        self.manualalphalabel.setObjectName("manualalphalabel")
        self.magneticfrequencyspinBox = QtWidgets.QDoubleSpinBox(self.Control)
        self.magneticfrequencyspinBox.setGeometry(QtCore.QRect(130, 120, 61, 31))
        ...
        self.rollingfrequencylabel.setGeometry(QtCore.QRect(10, 115, 111, 41))
        self.rollingfrequencylabel.setObjectName("rollingfrequencylabel")
        self.gammaspinBox = QtWidgets.QSpinBox(self.Control)
        self.gammaspinBox.setGeometry(QtCore.QRect(70, 55, 51, 22))
        ...
        self.psispinBox.setGeometry(QtCore.QRect(70, 25, 51, 22))
        ...
        self.label_6.setGeometry(QtCore.QRect(290, 0, 81, 16))
        self.label_6.setObjectName("label_6")
        self.manualfieldCoil1 = QtWidgets.QSpinBox(self.Control)
        self.manualfieldCoil1.setGeometry(QtCore.QRect(340, 15, 51, 22))
        self.manualfieldCoil1.setMinimum(-100)
        self.manualfieldCoil1.setMaximum(100)
        self.manualfieldCoil1.setProperty("value", 0)
        self.manualfieldCoil1.setObjectName("manualfieldCoil1")
        self.label_7 = QtWidgets.QLabel(self.Control)
        self.label_7.setGeometry(QtCore.QRect(270, 15, 61, 16))
        self.label_7.setObjectName("label_7")
        self.manualfieldCoil2 = QtWidgets.QSpinBox(self.Control)
        self.manualfieldCoil2.setGeometry(QtCore.QRect(340, 40, 51, 22))
        self.manualfieldCoil2.setMinimum(-100)
        self.manualfieldCoil2.setMaximum(100)
        self.manualfieldCoil2.setProperty("value", 0)
        self.manualfieldCoil2.setDisplayIntegerBase(10)
        self.manualfieldCoil2.setObjectName("manualfieldCoil2")
        self.label_8 = QtWidgets.QLabel(self.Control)
        self.label_8.setGeometry(QtCore.QRect(270, 40, 61, 16))
        self.label_8.setObjectName("label_8")
        self.manualfieldCoil3 = QtWidgets.QSpinBox(self.Control)
        self.manualfieldCoil3.setGeometry(QtCore.QRect(340, 65, 51, 22))
        self.manualfieldCoil3.setMinimum(-100)
        self.manualfieldCoil3.setMaximum(100)
        self.manualfieldCoil3.setProperty("value", 0)
        self.manualfieldCoil3.setDisplayIntegerBase(10)
        self.manualfieldCoil3.setObjectName("manualfieldCoil3")
        self.label_9 = QtWidgets.QLabel(self.Control)
        self.label_9.setGeometry(QtCore.QRect(270, 65, 61, 16))
        self.label_9.setObjectName("label_9")
        self.manualapplybutton = QtWidgets.QPushButton(self.Control)
        self.manualapplybutton.setGeometry(QtCore.QRect(280, 170, 101, 31))
...
"}")
        ...
        self.applyacousticbutton = QtWidgets.QPushButton(self.Control)
        self.applyacousticbutton.setGeometry(QtCore.QRect(200, 170, 51, 21))
...
"}")
        ...
        self.acousticfreqlabel = QtWidgets.QLabel(self.Control)
        ...
        self.acousticfreq_spinBox = QtWidgets.QSpinBox(self.Control)
        ...
        self.label_17.setGeometry(QtCore.QRect(270, 115, 61, 16))
        self.label_17.setObjectName("label_17")
        self.label_18 = QtWidgets.QLabel(self.Control)
        self.label_18.setGeometry(QtCore.QRect(270, 140, 61, 16))
        self.label_18.setObjectName("label_18")
        self.manualfieldCoil4 = QtWidgets.QSpinBox(self.Control)
        self.manualfieldCoil4.setGeometry(QtCore.QRect(340, 90, 51, 22))
        self.manualfieldCoil4.setMinimum(-100)
        self.manualfieldCoil4.setMaximum(100)
        self.manualfieldCoil4.setProperty("value", 0)
        self.manualfieldCoil4.setDisplayIntegerBase(10)
        self.manualfieldCoil4.setObjectName("manualfieldCoil4")
        self.manualfieldCoil5 = QtWidgets.QSpinBox(self.Control)
        self.manualfieldCoil5.setGeometry(QtCore.QRect(340, 115, 51, 22))
        self.manualfieldCoil5.setMinimum(-100)
        self.manualfieldCoil5.setMaximum(100)
        self.manualfieldCoil5.setProperty("value", 0)
        self.manualfieldCoil5.setDisplayIntegerBase(10)
        self.manualfieldCoil5.setObjectName("manualfieldCoil5")
        self.manualfieldCoil6 = QtWidgets.QSpinBox(self.Control)
        self.manualfieldCoil6.setGeometry(QtCore.QRect(340, 140, 51, 22))
        self.manualfieldCoil6.setMinimum(-100)
        self.manualfieldCoil6.setMaximum(100)
        self.manualfieldCoil6.setProperty("value", 0)
        self.manualfieldCoil6.setDisplayIntegerBase(10)
        self.manualfieldCoil6.setObjectName("manualfieldCoil6")
        self.Bxlabel = QtWidgets.QLabel(self.Control)
        self.Bxlabel.setGeometry(QtCore.QRect(140, 25, 31, 21))
        self.Bxlabel.setObjectName("Bxlabel")
        self.Bzlabel = QtWidgets.QLabel(self.Control)
        self.Bzlabel.setGeometry(QtCore.QRect(140, 85, 31, 21))
        self.Bzlabel.setObjectName("Bzlabel")
        self.Bylabel = QtWidgets.QLabel(self.Control)
        self.Bylabel.setGeometry(QtCore.QRect(140, 55, 31, 21))
        self.Bylabel.setObjectName("Bylabel")
        self.Bxspinbox = QtWidgets.QSpinBox(self.Control)
        self.Bxspinbox.setGeometry(QtCore.QRect(170, 25, 51, 22))
        self.Bxspinbox.setMinimum(-100)
        self.Bxspinbox.setMaximum(100)
        self.Bxspinbox.setSingleStep(5)
        self.Bxspinbox.setProperty("value", 0)
        self.Bxspinbox.setObjectName("Bxspinbox")
        self.Byspinbox = QtWidgets.QSpinBox(self.Control)
        self.Byspinbox.setGeometry(QtCore.QRect(170, 55, 51, 22))
        self.Byspinbox.setMinimum(-100)
        self.Byspinbox.setMaximum(100)
        self.Byspinbox.setSingleStep(5)
        self.Byspinbox.setProperty("value", 0)
        self.Byspinbox.setObjectName("Byspinbox")
        self.Bzspinbox = QtWidgets.QSpinBox(self.Control)
        self.Bzspinbox.setGeometry(QtCore.QRect(170, 85, 51, 22))
        self.Bzspinbox.setMinimum(-100)
        self.Bzspinbox.setMaximum(100)
        self.Bzspinbox.setSingleStep(5)
        self.Bzspinbox.setProperty("value", 0)
        self.Bzspinbox.setObjectName("Bzspinbox")
        self.tabWidget.addTab(self.Control, "")
        self.Algorithms = QtWidgets.QWidget()
        self.Algorithms.setObjectName("Algorithms")
        self.tabWidget_2 = QtWidgets.QTabWidget(self.Algorithms)
        self.tabWidget_2.setGeometry(QtCore.QRect(0, 70, 381, 141))
        self.tabWidget_2.setObjectName("tabWidget_2")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.rollradio = QtWidgets.QRadioButton(self.tab)
        self.rollradio.setGeometry(QtCore.QRect(10, 10, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(False)
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 0, 311, 101))
        self.label_2.setObjectName("label_2")
        self.tabWidget_2.addTab(self.tab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.swimradio = QtWidgets.QRadioButton(self.tab_2)
        self.swimradio.setGeometry(QtCore.QRect(10, 10, 51, 20))
        self.swimradio.setObjectName("swimradio")
        self.label_5 = QtWidgets.QLabel(self.tab_2)
        self.label_5.setGeometry(QtCore.QRect(80, 0, 311, 101))
        self.label_5.setObjectName("label_5")
        self.tabWidget_2.addTab(self.tab_2, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.orientradio = QtWidgets.QRadioButton(self.tab_3)
        self.orientradio.setGeometry(QtCore.QRect(10, 10, 61, 20))
        self.orientradio.setObjectName("orientradio")
        self.label_13 = QtWidgets.QLabel(self.tab_3)
        self.label_13.setGeometry(QtCore.QRect(70, 20, 311, 81))
        self.label_13.setObjectName("label_13")
        self.tabWidget_2.addTab(self.tab_3, "")
        self.tab_6 = QtWidgets.QWidget()
        self.tab_6.setObjectName("tab_6")
        self.ricochet_effect_checkbox = QtWidgets.QCheckBox(self.tab_6)
        self.ricochet_effect_checkbox.setGeometry(QtCore.QRect(10, 10, 31, 21))
        ...
        self.ricocheteffectlabel = QtWidgets.QLabel(self.tab_6)
        self.ricocheteffectlabel.setGeometry(QtCore.QRect(30, 10, 101, 21))
        self.ricocheteffectlabel.setObjectName("ricocheteffectlabel")
        self.label_4 = QtWidgets.QLabel(self.tab_6)
        self.label_4.setGeometry(QtCore.QRect(120, 20, 251, 81))
        self.label_4.setObjectName("label_4")
        self.tabWidget_2.addTab(self.tab_6, "")
        self.tab_4 = QtWidgets.QWidget()
        self.tab_4.setObjectName("tab_4")
        self.pushradio = QtWidgets.QRadioButton(self.tab_4)
        self.pushradio.setGeometry(QtCore.QRect(10, 10, 51, 20))
        self.pushradio.setObjectName("pushradio")
        self.spinningfreqbox = QtWidgets.QSpinBox(self.tab_4)
        self.spinningfreqbox.setGeometry(QtCore.QRect(300, 70, 51, 21))
        ...
        self.approachdistancelabel = QtWidgets.QLabel(self.tab_4)
        self.approachdistancelabel.setGeometry(QtCore.QRect(170, 40, 121, 21))
        self.approachdistancelabel.setObjectName("approachdistancelabel")
        self.approachdistancelabel_2 = QtWidgets.QLabel(self.tab_4)
        self.approachdistancelabel_2.setGeometry(QtCore.QRect(170, 70, 121, 21))
        self.approachdistancelabel_2.setObjectName("approachdistancelabel_2")
        self.approachdistancebox = QtWidgets.QSpinBox(self.tab_4)
        self.approachdistancebox.setGeometry(QtCore.QRect(300, 40, 51, 21))
        ...
        self.corriderwidthlabel = QtWidgets.QLabel(self.tab_4)
        self.corriderwidthlabel.setGeometry(QtCore.QRect(170, 10, 121, 21))
        self.corriderwidthlabel.setObjectName("corriderwidthlabel")
        self.corridorwidthbox = QtWidgets.QSpinBox(self.tab_4)
        self.corridorwidthbox.setGeometry(QtCore.QRect(300, 10, 51, 21))
        ...
        self.label_14.setGeometry(QtCore.QRect(10, 30, 151, 71))
        self.label_14.setObjectName("label_14")
        self.tabWidget_2.addTab(self.tab_4, "")
        self.MultiAgent = QtWidgets.QWidget()
        self.MultiAgent.setObjectName("MultiAgent")
        self.multiagent_radio = QtWidgets.QRadioButton(self.MultiAgent)
        self.multiagent_radio.setGeometry(QtCore.QRect(10, 0, 101, 41))
        self.multiagent_radio.setObjectName("multiagent_radio")
        self.tabWidget_2.addTab(self.MultiAgent, "")
        self.tab_5 = QtWidgets.QWidget()
        self.tab_5.setObjectName("tab_5")
        self.tabWidget_2.addTab(self.tab_5, "")
        self.arrivalthreshbox = QtWidgets.QSpinBox(self.Algorithms)
        self.arrivalthreshbox.setGeometry(QtCore.QRect(130, 40, 51, 21))
        self.arrivalthreshbox.setMinimum(1)
        self.arrivalthreshbox.setMaximum(1000)
        self.arrivalthreshbox.setProperty("value", 25)
        self.arrivalthreshbox.setObjectName("arrivalthreshbox")
        self.arrivalthreshlabel = QtWidgets.QLabel(self.Algorithms)
        self.arrivalthreshlabel.setGeometry(QtCore.QRect(10, 40, 131, 21))
        self.arrivalthreshlabel.setObjectName("arrivalthreshlabel")
        self.autoacousticbutton = QtWidgets.QPushButton(self.Algorithms)
        self.autoacousticbutton.setGeometry(QtCore.QRect(330, 30, 51, 31))
...
"}")
        ...
        self.label_3 = QtWidgets.QLabel(self.Algorithms)
        self.label_3.setGeometry(QtCore.QRect(10, 10, 371, 16))
        self.label_3.setObjectName("label_3")
        self.label_15 = QtWidgets.QLabel(self.Algorithms)
        self.label_15.setGeometry(QtCore.QRect(200, 40, 121, 16))
        self.label_15.setObjectName("label_15")
        self.tabWidget.addTab(self.Algorithms, "")
        ...
        self.make_inf_path.setGeometry(QtCore.QRect(50, 40, 121, 21))
...
"            }")
        ...
        self.RRTtreesizelabel_2.setGeometry(QtCore.QRect(170, 110, 121, 21))
        self.RRTtreesizelabel_2.setObjectName("RRTtreesizelabel_2")
        self.with_2 = QtWidgets.QLabel(self.Planning)
        self.with_2.setGeometry(QtCore.QRect(290, 40, 71, 21))
        self.with_2.setObjectName("with_2")
        self.with_3 = QtWidgets.QLabel(self.Planning)
        self.with_3.setGeometry(QtCore.QRect(20, 10, 251, 21))
        self.with_3.setObjectName("with_3")
        self.with_4 = QtWidgets.QLabel(self.Planning)
        self.with_4.setGeometry(QtCore.QRect(20, 70, 371, 41))
        self.with_4.setObjectName("with_4")
        self.with_5 = QtWidgets.QLabel(self.Planning)
        self.with_5.setGeometry(QtCore.QRect(20, 140, 371, 41))
        self.with_5.setObjectName("with_5")
        self.with_6 = QtWidgets.QLabel(self.Planning)
        self.with_6.setGeometry(QtCore.QRect(180, 40, 41, 21))
...
" (frames)"))
        ...
        self.croplengthlabel.setText(_translate("MainWindow", "Crop Length(um)"))
        ...
        self.import_excel_actions.setText(_translate("MainWindow", "Import Excel "))
        self.apply_actions.setText(_translate("MainWindow", "Apply Excel "))
        self.ArduinoPortLabel.setText(_translate("MainWindow", "Arduino Port:"))
        self.simulationbutton.setText(_translate("MainWindow", "Simulation On"))
        self.gradient_status_checkbox.setText(_translate("MainWindow", "Gradient Status"))
        self.equal_field_checkbox.setText(_translate("MainWindow", "Equal Field Status"))
...
"Frequency (Hz):"))
        ...
        self.label_7.setText(_translate("MainWindow", "Coil1 (+Y):"))
        self.label_8.setText(_translate("MainWindow", "Coil2 (+X):"))
        self.label_9.setText(_translate("MainWindow", "Coil3 (-Y):"))
...
"Frequency (Hz)"))
        self.label_16.setText(_translate("MainWindow", "Coil4 (-X):"))
        self.label_17.setText(_translate("MainWindow", "Coil5 (+Z):"))
        self.label_18.setText(_translate("MainWindow", "Coil6 (-Z):"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Control), _translate("MainWindow", "Manual Control"))
        self.rollradio.setText(_translate("MainWindow", "Roll"))
        self.label_2.setText(_translate("MainWindow", "This Algorithm simple applies a rotating\n"
" magnetic field that results in rolling motion \n"
"towards a target coordinate or along a path \n"
" generated in the \"path planning\" tab. \n"
"\"Arrive Thresh\" indictes a threshold distance\n"
" in pixels. "))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab), _translate("MainWindow", "Simple Roll"))
        self.swimradio.setText(_translate("MainWindow", "Swim"))
        self.label_5.setText(_translate("MainWindow", "This Algorithm simple applies a rotating\n"
" magnetic field that results in a swimming motion \n"
"towards a target coordinate or along a path \n"
" generated in the \"path planning\" tab. \n"
"\"Arrive Thresh\" indictes a threshold distance\n"
" in pixels. "))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_2), _translate("MainWindow", "Simple Swim"))
        self.orientradio.setText(_translate("MainWindow", "Orient"))
        self.label_13.setText(_translate("MainWindow", "This Algorithm autonmously adjusts the direction \n"
" of the uniform magnetic field based on the velocty \n"
" of the microrobot. \n"
" Essentailly. it learns the direction of the field to \n"
" apply to guide a self-propelled MR to a target coord."))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_3), _translate("MainWindow", "Simple Orient"))
        self.ricocheteffectlabel.setText(_translate("MainWindow", "Ricochet Effect:"))
        self.label_4.setText(_translate("MainWindow", "This Algorithm simply enables a condition\n"
" that bounces a microrobot off the walls \n"
" of the image frame. "))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_6), _translate("MainWindow", "Ricochet"))
        ...
        self.label_14.setText(_translate("MainWindow", "This is an autonmosly \n"
" pushing algorithm based\n"
" on micro vortices\n"
" and guiding corridors"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_4), _translate("MainWindow", "Auto Push"))
        self.multiagent_radio.setText(_translate("MainWindow", "Multi Agent"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.MultiAgent), _translate("MainWindow", "MultiAgent"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_5), _translate("MainWindow", "MPC Roll"))
        ...
        self.label_3.setText(_translate("MainWindow", "Algorithms begin by selecting the \"Control\" button above"))
        self.label_15.setText(_translate("MainWindow", "Acoustic Freq Finder:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Algorithms), _translate("MainWindow", "Control Algorithms"))
        ...
        self.with_2.setText(_translate("MainWindow", "waypoints"))
        self.with_3.setText(_translate("MainWindow", "1) Generate Infinity Path "))
        self.with_4.setText(_translate("MainWindow", "2)  Use RRT algorithm by clicking with the right mouse button. \n"
"Use the Cell Mask to ensure obstacles are outlined in white"))
        self.with_5.setText(_translate("MainWindow", "3) Draw Path. The program will continously add waypoints every\n"
