...
"            }")
        ...
        self.controlbutton.setGeometry(QtCore.QRect(140, 40, 111, 31))
...
"            }")
        ...
        self.initializebutton = QtWidgets.QPushButton(self.frame)
        self.initializebutton.setGeometry(QtCore.QRect(20, 40, 111, 31))
...
"                padding-top: 5px;\n"
"            }")
        self.initializebutton.setCheckable(False)
...
"            }")
        ...
        self.pushradio.setGeometry(QtCore.QRect(200, 0, 51, 20))
        self.pushradio.setObjectName("pushradio")
        self.gradient_status_checkbox = QtWidgets.QCheckBox(self.Control)
        self.gradient_status_checkbox.setGeometry(QtCore.QRect(320, 0, 71, 21))
        ...
        self.equal_field_checkbox.setGeometry(QtCore.QRect(320, 20, 81, 21))
...
"}")
        ...
        self.multiagent_radio = QtWidgets.QRadioButton(self.Control)
        self.multiagent_radio.setGeometry(QtCore.QRect(260, 0, 51, 20))
...
"            }")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(19, 369, 371, 251))
...
"Frequency (Hz):"))
        ...
        self.multiagent_radio.setText(_translate("MainWindow", "Multi \n"
"Agent"))
